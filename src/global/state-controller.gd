...
const AbstractDayTimer = preload("res://src/managers/day-timer/day-timer.gd")
const AbstractEconomyManager = preload("res://src/managers/economy-manager/economy-manager.gd")
