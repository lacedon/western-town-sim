...
func _ready() -> void:
  ...
  # NavigationServer2D.bake_from_source_geometry_data(NavigationPolygon
...
func _on_add_environment_obstacle(obstacle_size: Vector2i, obstacle_position: Vector2) -> void:
  _obstacles.append(Vector4(obstacle_position.x, obstacle_position.y, obstacle_size.x, obstacle_size.y))

  rebake_navigation()

func _on_remove_environment_obstacle(obstacle_size: Vector2i, obstacle_position: Vector2) -> void:
  _obstacles.erase(Vector4(obstacle_position.x, obstacle_position.y, obstacle_size.x, obstacle_size.y))
